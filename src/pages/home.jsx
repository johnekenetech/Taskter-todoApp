    ...
    return (
        <div className="flex justify-center items-center min-h-screen bg-black">
            <div className="text-center">
                    ...
                    <input type='text' placeholder="Enter Name" value={name} className=" font-semibold outline-none mt-8 pl-4 py-1 sm:pl-10 sm:py-2 md:px-10" onChange={handleChange} name={name}/>
                    <div className="flex justify-center mt-12 sm:mt-16">
                        <button onClick={handleNavigate}><img src="enter.png" alt="" className="sm:w-[75px]"/></button>
                    </div>
